...
export const HIDE_FIELDS_REORDER_WIDTH = 9;
export const HIDE_FIELDS_REORDER_HEIGHT = 12;
export const HIDE_FIELDS_REORDER_RIGHT_OFFSET = 20;
export const HIDE_FIELDS_REORDER_LEFT =
  HIDE_FIELDS_DROPDOWN_WIDTH -
  HIDE_FIELDS_REORDER_RIGHT_OFFSET -
  HIDE_FIELDS_REORDER_WIDTH;
export const HIDE_FIELDS_REORDER_TOP = 62;
export const HIDE_FIELDS_REORDER_ROW_GAP = HIDE_FIELDS_REORDER_HEIGHT + 14;
